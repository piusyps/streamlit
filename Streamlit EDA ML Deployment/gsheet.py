...
def retrieveData():
    ...
    credentials = ServiceAccountCredentials.from_json_keyfile_name('hopeful-altar-396808-8971fa5af264.json', scope)

    # Connect to Google Sheets
    client = gspread.authorize(credentials)

    # Open the desired sheet
    sheet = client.open_by_key('1mJGKAiWn2-QNoG1c8g2rI_k--hjFEKjD_x04_8WNxpw').get_worksheet(0)
